...
print('Pegasos Accuracy on Test set: {}'.format(accuracy[1]))

#-------------------------------------------------------------------------------
# Assign to best_theta, the weights learned by the most
...
print("Most Explanatory Word Features for Positive Reviews")
print(sorted_word_features[:10])

print("Most Explanatory Word Features for Negative Reviews")
print(sorted_word_features[-10:])
...
accuracy = p1.classifier_accuracy(
                p1.pegasos,
                train_bow_features_ex_stopwords,
                test_bow_features_ex_stopwords,
                train_labels,
                test_labels,
                T = 25,
                L = .01)

print('Pegasos Accuracy on Test set without stopwords: {}'.format(accuracy[1]))


train_bow_features_ex_stopwords = p1.extract_bow_feature_vectors(train_texts, bow_ex_stp, method='Count')
test_bow_features_ex_stopwords = p1.extract_bow_feature_vectors(test_texts, bow_ex_stp, method='Count')
...
print('Pegasos Accuracy on Test set (count features + no stopwords): {}'.format(accuracy[1]))
